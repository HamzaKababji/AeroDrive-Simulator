...
#include "AeroDriveSimulatorPlayerController.generated.h"

class UInputMappingContext;
class AAeroDriveSimulatorPawn;
class UAeroDriveSimulatorUI;
 ...
 */
UCLASS(abstract)
class AAeroDriveSimulatorPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AAeroDriveSimulatorPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="UI")
	TSubclassOf<UAeroDriveSimulatorUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UAeroDriveSimulatorUI> VehicleUI;
