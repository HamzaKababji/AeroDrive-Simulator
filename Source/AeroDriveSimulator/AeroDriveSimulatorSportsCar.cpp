...
#include "AeroDriveSimulatorSportsCar.h"
#include "AeroDriveSimulatorSportsWheelFront.h"
#include "AeroDriveSimulatorSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AAeroDriveSimulatorSportsCar::AAeroDriveSimulatorSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAeroDriveSimulatorSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAeroDriveSimulatorSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAeroDriveSimulatorSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAeroDriveSimulatorSportsWheelRear::StaticClass();
