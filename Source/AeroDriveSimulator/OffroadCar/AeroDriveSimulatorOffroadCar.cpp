...
#include "AeroDriveSimulatorOffroadCar.h"
#include "AeroDriveSimulatorOffroadWheelFront.h"
#include "AeroDriveSimulatorOffroadWheelRear.h"
...
AAeroDriveSimulatorOffroadCar::AAeroDriveSimulatorOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UAeroDriveSimulatorOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UAeroDriveSimulatorOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UAeroDriveSimulatorOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UAeroDriveSimulatorOffroadWheelRear::StaticClass();
